...
var e = new Error('Operator not al last.')
  ...
  var peg$f28 = function() { return 'OR'; };
  var peg$f29 = function() { return 'AND'; };
  var peg$f30 = function() { return 'NOT'; };
  var peg$f31 = function() { return 'OR'; };
  var peg$f32 = function() { return 'AND'; };
  var peg$f33 = function() { return 'NOT'};
  var peg$f34 = function(val) {if (val.join("") > 99) { var e = new Error('Proximity number greterthen 99'); throw e} return 'ADJ'+":"+val.join("")};
  var peg$f35 = function(val) {if (val.join("") > 99) { var e = new Error('Proximity number greterthen 99'); throw e} return 'NEAR'+":"+val.join("")};
  var peg$f36 = function(val) {if (val.join("") > 99) { var e = new Error('Proximity number greterthen 99'); throw e} return 'SAME'+":"+val.join("")};
