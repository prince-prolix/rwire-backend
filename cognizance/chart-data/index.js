...
import { getElasticQuerySmartSearch, validationQuery } from "../../smart-search/index.js";
...
export const getElasticQueryChartData = async (
  ...
  const { field1, field2, isMultiSeries, topNumber, dataSize ,chartFilters} = requestOptions;
