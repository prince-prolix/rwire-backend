import { checkSpecialConditions } from "../common/query-functions.js";
...
export const getFinalElasticCountQuery =
 async (queryToSearch,options={}) =>{
  ...
  const getElasticCountQueryNumberSearchWithIncludes =
  ...
  export const getElasticCountQuery =
  (rawQuery, options = {}) => {
    let success = true;
    const {
          filters
